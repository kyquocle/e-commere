<%-- 
    Document   : 404
    Created on : Feb 17, 2023, 6:06:10 PM
    Author     : DELL
--%>
...
<div class="text-center py-5 my-lg-5">
<!--<div class="error mx-auto mt-lg-5 pt-lg-5" data-text="404">404</div>-->
<!--<p class="lead text-gray-800 mb-5">You need to sign in to see Personal Information</p>-->
...
<!--<a href="UpdateAccountController?cusername=${cust.username}">Update</a>-->
</div>
</div>
</form>
<%--</c:forEach>--%>
