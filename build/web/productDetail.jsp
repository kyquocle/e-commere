<%-- 
    ...
    Created on : Mar 2, 2023, 9:05:50 AM
    Author     : DELL
--%>
...
<p class="mb-0 text-white-50 small"><a href="https://askbootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3a5f425b574a565f7a5d575b535614595557">[email&#160;protected]</a></p>
</div>
</div>
</div>-->
...
<a href="index.jsp">&larr; Back to Dashboard</a>
  ...
  <c:set var="pro" value="${requestScope.PRODUCT_DETAIL}" />
  
          <!--<a href="ProductDetailController?pid=${requestScope.PRODUCT_DETAIL}" class="text-decoration-none text-dark col-lg-3 col-md-6 mb-4" >-->
<!--         <img src="data:image/jpg    ;base64,${pro.base64ImageData}"  width="200px" height="200px"/>
          <div class="d-flex align-items-center mt-3 mb-2">
            <p class="text-black h6 m-0">${pro.proName}</p>
            <span class="badge badge-light ml-auto"><i class='fas fa-dollar-sign'></i> ${pro.price}</span>
          </div>
          <p class="small mb-2"><span class="badge badge-light ml-auto"><i class='fas fa-dollar-sign'></i> ${pro.price}</span> <i class="mdi mdi-silverware-fork-knife ml-2 mr-1"></i> ${pro.catgoryName} <i class="mdi mdi-motorbike ml-2 mr-2"></i>Freeship</p>
        </a>-->
