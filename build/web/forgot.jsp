<%-- 
    Document   : forgot
    Created on : Feb 17, 2023, 6:26:35 PM
    Author     : DELL
--%>
...
<p class="mb-5">please enter your email address to continue</p>
<form>
...
<div class="mb-3">
<a href="#" class="btn btn-primary btn-block mb-2" data-toggle="modal" data-target="#myforgotModal">Continue</a>
</div>
</form>
</div>
</div>
...
<a href="index.jsp" class="btn btn-light btn-block mt-2 mb-3">Send again</a>
</div>
</div>
</div>
</div>
