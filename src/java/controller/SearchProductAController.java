 ...
 * @author DELL
 */
@WebServlet(name = "SearchProductAController", urlPatterns = {"/SearchProductAController"})
public class SearchProductAController extends HttpServlet {

     private final String SEARCH_PRODUCT ="search.jsp";
